...
The single thin client is the seam: add a method that calls another `/v1/...` route (e.g. one of account.keys.create, account.keys.suspected_compromise, account.keys.rotate, logs.search) and reuse it from your own code.
